...
import CommunityBonding from "./../data/CommunityBonding.json" with {type: "json"};
        ...
        <div className="bg-[url(./assets/genericUBbg.jpg)] bg-cover py-10 px-10 h-150 flex items-end justify-start">
            ...
            <div className="text-white h-fit text-shadow-lg/60">
                ...
                <p className="text-2xl">
                    From the classroom to the boardroom, SASE powers the full
                    talent journey — connecting top STEM talent with
                    opportunities, driving professional growth, and helping
                    companies hire, retain, and promote diverse leaders.
                </p>
            </div>
        </div>
    </div>
...
const firstdesc = (
    <section className="flex justify-center items-center h-[95vh] text-black overflow-hidden">
        <div className="w-1/2 px-20">
            ...
            <p className="text-2xl">
                Society of Asian Scientists and Engineers (SASE) is a national
                organization dedicated to the advancement of Asian heritage
